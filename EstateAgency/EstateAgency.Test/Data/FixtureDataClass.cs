...
public static class FixtureDataClass
{
    ...
    {
        new() { Id = 1, Type = RealEstateType.Apartment, Purpose = RealEstatePurpose.Residential, CadastralNumber = "63:01:0000001", Address = "Moscow, Tverskaya 10", FloorsTotal = 12, TotalArea = 55.5, Rooms = 2, CeilingHeight = 2.7, FloorNumber = 7, HasEncumbrances = false },
        new() { Id = 2, Type = RealEstateType.House, Purpose = RealEstatePurpose.Residential, CadastralNumber = "63:02:0000002", Address = "Samara, Lenina 23", FloorsTotal = 2, TotalArea = 120.0, Rooms = 5, CeilingHeight = 3.0, FloorNumber = 0, HasEncumbrances = false },
        new() { Id = 3, Type = RealEstateType.Cottage, Purpose = RealEstatePurpose.Recreational, CadastralNumber = "63:03:0000003", Address = "Sochi, Green Hills 5", FloorsTotal = 1, TotalArea = 80.2, Rooms = 3, CeilingHeight = 2.8, FloorNumber = 0, HasEncumbrances = false },
        new() { Id = 4, Type = RealEstateType.Office, Purpose = RealEstatePurpose.Commercial, CadastralNumber = "63:04:0000004", Address = "Moscow, Business Center 15", FloorsTotal = 20, TotalArea = 300.0, Rooms = 10, CeilingHeight = 3.5, FloorNumber = 10, HasEncumbrances = true },
        new() { Id = 5, Type = RealEstateType.Townhouse, Purpose = RealEstatePurpose.Residential, CadastralNumber = "63:05:0000005", Address = "Kazan, Victory Ave 8", FloorsTotal = 3, TotalArea = 140.0, Rooms = 6, CeilingHeight = 3.0, FloorNumber = 0, HasEncumbrances = false },
        new() { Id = 6, Type = RealEstateType.Shop, Purpose = RealEstatePurpose.Commercial, CadastralNumber = "63:06:0000006", Address = "Samara, Market Street 12", FloorsTotal = 1, TotalArea = 90.0, Rooms = 2, CeilingHeight = 3.2, FloorNumber = 1, HasEncumbrances = false },
        new() { Id = 7, Type = RealEstateType.Warehouse, Purpose = RealEstatePurpose.Industrial, CadastralNumber = "63:07:0000007", Address = "Samara, Industrial Zone 9", FloorsTotal = 1, TotalArea = 500.0, Rooms = 1, CeilingHeight = 5.0, FloorNumber = 0, HasEncumbrances = true },
        new() { Id = 8, Type = RealEstateType.Garage, Purpose = RealEstatePurpose.Utility, CadastralNumber = "63:08:0000008", Address = "Samara, Garage Co-op 3", FloorsTotal = 1, TotalArea = 20.0, Rooms = 1, CeilingHeight = 2.5, FloorNumber = 0, HasEncumbrances = false },
        new() { Id = 9, Type = RealEstateType.Apartment, Purpose = RealEstatePurpose.Residential, CadastralNumber = "63:09:0000009", Address = "Moscow, Arbat 22", FloorsTotal = 16, TotalArea = 75.0, Rooms = 3, CeilingHeight = 2.9, FloorNumber = 9, HasEncumbrances = false },
        new() { Id = 10, Type = RealEstateType.Office, Purpose = RealEstatePurpose.Commercial, CadastralNumber = "63:10:0000010", Address = "Saint Petersburg, Nevsky 100", FloorsTotal = 8, TotalArea = 220.0, Rooms = 8, CeilingHeight = 3.4, FloorNumber = 5, HasEncumbrances = true },
    };
